/**
 * Purpose: Tactile 3D button for choosing words in Odd Word Out.
...
export interface WordChoiceButtonProps {
...
export const WordChoiceButton: React.FC<WordChoiceButtonProps> = React.memo(
...
WordChoiceButton.displayName = 'WordChoiceButton';
